...
{% hint style="info" %}
[Here](https://docs.google.com/document/d/1R7\_ONukFVptqRGmm1R4VpRpmQ9hyfwMMAqd6FsG5wgI/edit?usp=sharing) is a view-only version of this section. Share with anyone.
{% endhint %}
...
* All table names should use [**snake case**](https://en.wikipedia.org/wiki/Snake\_case)**.**
...
* All column names should use [**snake case**](https://en.wikipedia.org/wiki/Snake\_case)**.**
...
* All data pipeline definition files should use [**snake case**](https://en.wikipedia.org/wiki/Snake\_case)**.**
...
The data unit test files located in [civis\_pipelines/test/data unit test/expectations/](https://github.com/CityOfBoston/civis\_pipelines/tree/master/tests/data\_unit\_tests/expectations) should be named after the table they are running the data unit test on.
...
* All data unit test files should use [**snake case**](https://en.wikipedia.org/wiki/Snake\_case) **** (except the hyphen).
